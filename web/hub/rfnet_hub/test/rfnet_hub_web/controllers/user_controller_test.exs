defmodule RfnetHubWeb.UserControllerTest do
  use RfnetHubWeb.ConnCase

  alias RfnetHub.Account
  alias RfnetHub.Account.User

  @create_attrs %{callsign: "some callsign", email: "some email", has_password: true, password: "some password", verified: true}
