...
var _user$project$Command$StartRequest = function (a) {
	return {ctor: 'StartRequest', _0: a};
};
...
var _user$project$Event$encodeCmd = F2(
	function (cmd, seed) {
		var _p0 = function () {
			var _p1 = cmd;
			switch (_p1.ctor) {
					...
					var config_retry = _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'bps',
								_1: _elm_lang$core$Json_Encode$int(_p4.retry.bps)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'bps_scale',
									_1: _elm_lang$core$Json_Encode$float(_p4.retry.bps_scale)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'delay_ms',
										_1: _elm_lang$core$Json_Encode$int(_p4.retry.delay_ms)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'retry_attempts',
											_1: _elm_lang$core$Json_Encode$int(_p4.retry.retry_attempts)
										},
										_1: {ctor: '[]'}
									}
								}
										...
										_1: _elm_lang$core$Json_Encode$object(
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'link_width',
													_1: _elm_lang$core$Json_Encode$int(_p3.link_width)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'fec',
														_1: _elm_lang$core$Json_Encode$bool(_p3.fec)
													},
													_1: {
														ctor: '::',
														_0: {
															ctor: '_Tuple2',
															_0: 'retry',
															_1: _elm_lang$core$Json_Encode$bool(_p3.retry)
														},
														_1: {
															ctor: '::',
															_0: {
																ctor: '_Tuple2',
																_0: 'broadcast_rate',
																_1: _elm_lang$core$Json_Encode$int(_p3.broadcast_rate)
															},
															_1: {ctor: '[]'}
														}
													}
					...
					var config_obj = _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'callsign',
									_1: _elm_lang$core$Json_Encode$string(_p4.callsign)
								},
								_1: {
									ctor: '::',
				...
				default:
					...
					var _p6 = A2(
						_elm_lang$core$Random$step,
						A2(_elm_lang$core$Random$int, 0, 65535),
						seed);
					var id = _p6._0;
					var next_seed = _p6._1;
					var contents = _elm_lang$core$Json_Encode$object(
						{
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'url',
									_1: _elm_lang$core$Json_Encode$string(_p7.url)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'body',
										_1: _elm_lang$core$Json_Encode$string(_p7.content)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'addr',
											_1: _elm_lang$core$Json_Encode$string('KI7EST@rfnet.net')
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'method',
												_1: _elm_lang$core$Json_Encode$string(method_str)
											},
											_1: {ctor: '[]'}
										}
									}
					...
					return {
						...
						_0: _elm_lang$core$Json_Encode$object(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Request', _1: contents},
								_1: {ctor: '[]'}
							}),
						_1: next_seed
					};
		...
		var json_value = _p0._0;
		var new_seed = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Json_Encode$encode, 0, json_value),
			_1: new_seed
		};
	});
...
var _user$project$Event$decode = function (str) {
	...
	if (_p10.ctor === 'Ok') {
		...
		return _user$project$Event$DecodeError(_p10._0);
	}
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				var _p3 = _p0._0;
				var _p1 = A2(_user$project$Event$encodeCmd, _p3, model.seed);
				var encoded = _p1._0;
				var next_seed = _p1._1;
				var _p2 = _p3;
				if (_p2.ctor === 'Configure') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{config: _p2._0, seed: next_seed}),
						_1: A2(_elm_lang$websocket$WebSocket$send, model.socketAddr, encoded)
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$Main$viewNode = F2(
	function (state, request) {
		...
		var index_mapper = function (i) {
			var _p4 = A2(_elm_lang$core$Array$get, i, modes_array);
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Json_Decode$succeed(
								...
								_elm_lang$html$Html$button,
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Event$Command(
											_user$project$Command$StartRequest(request))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Send Request'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$viewInterface = F2(
	function ($interface, request) {
		var mode = function () {
			var _p6 = $interface.mode;
			switch (_p6.ctor) {
				case 'Node':
					return A2(_user$project$Main$viewNode, _p6._0, request);
				case 'Link':
...
var _user$project$Main$floatInput = F3(
	function (field, f_value, cmd) {
		var event = function (v) {
			var _p7 = _elm_lang$core$String$toFloat(v);
			if (_p7.ctor === 'Ok') {
				return cmd(_p7._0);
			} else {
...
var _user$project$Main$numberInput = F3(
	function (field, num_value, cmd) {
		var event = function (v) {
			var _p8 = _elm_lang$core$String$toInt(v);
			if (_p8.ctor === 'Ok') {
				return cmd(_p8._0);
			} else {
				return _user$project$Event$DecodeError(_p8._0);
			}
		};
		var changed = _elm_lang$html$Html_Events$onInput(event);
		return A2(
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: {
			...
			seed: _elm_lang$core$Random$initialSeed(flags.unix_timestamp)
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
		...
		function (socket) {
			return A2(
				...
				function (unix_timestamp) {
					return _elm_lang$core$Json_Decode$succeed(
						{socket: socket, unix_timestamp: unix_timestamp});
				},
				A2(_elm_lang$core$Json_Decode$field, 'unix_timestamp', _elm_lang$core$Json_Decode$int));
		},
		A2(_elm_lang$core$Json_Decode$field, 'socket', _elm_lang$core$Json_Decode$string)));
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {socketAddr: a, log: b, $interface: c, config: d, request: e, seed: f};
	});
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {socket: a, unix_timestamp: b};
	});
